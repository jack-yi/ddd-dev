...
const (
	UserCenter_VerifyToken_FullMethodName = "/usercenter.UserCenter/VerifyToken"
	UserCenter_CheckRole_FullMethodName   = "/usercenter.UserCenter/CheckRole"
...
type UserCenterClient interface {
	...
	CheckRole(ctx context.Context, in *CheckRoleReq, opts ...grpc.CallOption) (*CheckRoleResp, error)
...
func (c *userCenterClient) CheckRole(ctx context.Context, in *CheckRoleReq, opts ...grpc.CallOption) (*CheckRoleResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckRoleResp)
	err := c.cc.Invoke(ctx, UserCenter_CheckRole_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userCenterClient) GetUserInfo(ctx context.Context, in *GetUserInfoReq, opts ...grpc.CallOption) (*UserInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserInfo)
...
type UserCenterServer interface {
	...
	CheckRole(context.Context, *CheckRoleReq) (*CheckRoleResp, error)
...
func (UnimplementedUserCenterServer) CheckRole(context.Context, *CheckRoleReq) (*CheckRoleResp, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckRole not implemented")
}
func (UnimplementedUserCenterServer) GetUserInfo(context.Context, *GetUserInfoReq) (*UserInfo, error) {
...
func _UserCenter_CheckRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckRoleReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserCenterServer).CheckRole(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserCenter_CheckRole_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserCenterServer).CheckRole(ctx, req.(*CheckRoleReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserCenter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserCenter_CheckRole_Handler,
		},
		{
